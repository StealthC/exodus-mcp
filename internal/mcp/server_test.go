...
func newFakeStatus() bridge.Status {
	return bridge.Status{
		...
		BridgeEnabled:       true,
		LoadedModuleCount:   3,
		SupportedOperations: []string{"status", "emulator_status", "mem_spaces", "mem_read", "regs_get", "disasm", "cpu_control", "breakpoint_set", "breakpoint_list", "breakpoint_remove", "rom_load", "trace_capture"},
	}
}
